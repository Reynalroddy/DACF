      ...
      <div className="container mx-auto px-4 py-10">
        <div className="max-w-4xl text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 text-balance leading-tight">
            From Heartbeat to Hope:{" "}
            <span className="text-teal-400">
              Reducing Cardiovascular Deaths
            </span>{" "}
            with Life Support Training in Nigeria
          </h1>
          <p className="text-lg sm:text-xl mb-2 text-pretty">
            Every Naira Counts: Help Reduce Preventable Cardiac Deaths in
            Nigeria.
          </p>
          <p className="text-base sm:text-lg mb-2 text-pretty">
            Be the Difference Between Life and Death—Sponsor Critical Care
            Training.
          </p>
          <p className="text-base sm:text-lg mb-2 text-pretty">
            Your Gift Trains a Lifesaver, Your Support Saves a Life.
          </p>
